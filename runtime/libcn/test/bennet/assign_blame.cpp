 ...
 * built by bennet_domain_from_ownership_uintptr_t (the D6 fix,
 * doc/RUNTIME-ABSINT.md §3.6), with the propagated requirement in element_0
...
// -----------------------------------------------------------------------------
// --dynamic-absint-assign mode dispatch (P6.7 doc-aligned semantics):
