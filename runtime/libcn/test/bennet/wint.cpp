...
TEST_F(LibBennet, ArbitraryWIntI64) {
  bennet_set_size(15);
  for (int i = 0; i < 100; i++) {
    int64_t val = bennet_arbitrary_wint(int64_t, -12, 53);
    EXPECT_LT(val, 17);
    EXPECT_GE(val, -12);
  }
}
...
TEST_F(LibBennet, OverflowArbitraryWIntU64_JustLower) {
  ...
  for (int i = 0; i < 1000; i++) {
    uint64_t val = bennet_arbitrary_wint(uint64_t, UINT64_MAX - 100, 53);
    EXPECT_GE(val, 0);
    EXPECT_LT(val, 50);
  }
}
...
TEST_F(LibBennet, OverflowArbitraryWIntI64_RightOfZero) {
  ...
  int64_t val = bennet_arbitrary_wint(int64_t, INT64_MAX - 100, 53);
  int64_t min = val;
  int64_t max = val;
...
TEST_F(LibBennet, OverflowArbitraryWIntI64_LeftOfZero) {
  ...
  int64_t val = bennet_arbitrary_wint(int64_t, -53, INT64_MIN + 100);
  int64_t min = val;
  int64_t max = val;
...
TEST_F(LibBennet, OverflowArbitraryWIntI64_DisjointGTZero) {
  ...
  int64_t val = bennet_arbitrary_wint(int64_t, 60, 20);
  int64_t min = val;
  int64_t max = val;
  for (int i = 0; i < 1000; i++) {
    int64_t val = bennet_arbitrary_wint(int64_t, 60, 20);
...
TEST_F(LibBennet, OverflowArbitraryWIntI64_DisjointLTZero) {
  ...
  int64_t val = bennet_arbitrary_wint(int64_t, -20, -60);
  int64_t min = val;
  int64_t max = val;
  for (int i = 0; i < 1000; i++) {
    int64_t val = bennet_arbitrary_wint(int64_t, -20, -60);
...
TEST_F(LibBennet, OverflowArbitraryWIntI64_DisjointLeanRight) {
  ...
  int64_t val = bennet_arbitrary_wint(int64_t, 65, -75);
  int64_t min = val;
  int64_t max = val;
  for (int i = 0; i < 1000; i++) {
    int64_t val = bennet_arbitrary_wint(int64_t, 65, -75);
...
TEST_F(LibBennet, OverflowArbitraryWIntI64_DisjointLeanLeft) {
  ...
  int64_t val = bennet_arbitrary_wint(int64_t, 70, -70);
  int64_t min = val;
  int64_t max = val;
  for (int i = 0; i < 1000; i++) {
    int64_t val = bennet_arbitrary_wint(int64_t, 70, -70);
