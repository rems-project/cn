/* C preprocessor macros for CN testing framework
 * These macros are used by generated test code and cannot be generated by cbindgen.
 * This file is appended to the cbindgen-generated test.h during the build process.
 *
 * NOTE: This file should only contain macros and supporting type definitions.
 * Function declarations are provided by the cbindgen-generated portion of test.h.
 */

/* Additional includes needed by the macros */
#include <sys/time.h>
...
/* Type definitions needed by macros (not generated by cbindgen) */

/* Alias for backward compatibility with macros */
#define tyche_line_info cn_TycheLineInfo

/* Note: enum cn_test_gen_progress and struct cn_test_input are defined
 * before cbindgen function declarations via dune build rule */

/* Note: enum cn_test_result is defined in result.h */

/* Function pointer type for test cases */
typedef enum cn_test_result cn_test_case_fn(struct cn_test_input test_input);

/* Note: cn_Option_CnTestCaseFn and cn_bennet_sizing_strategy are defined
 * before cbindgen function declarations via dune build rule */
