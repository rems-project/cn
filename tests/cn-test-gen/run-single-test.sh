...
ALT_CONFIGS=(
  ...
  "--sizing-strategy=uniform --random-size-splits --experimental-product-arg-destruction --smt-pruning=fast"
  "--random-size-splits --experimental-runtime --experimental-learning --smt-pruning=slow --print-satisfaction-info --output-tyche=results.jsonl")
