...
def main():
    ...
    if args.symbolic:
        ...
        alt_configs = [
            ...
            ("lucas", "--print-satisfaction-info --output-tyche=results.jsonl --inline=nonrec --static-absint --domains=tristate --dynamic-arbitrary-domain --dynamic-arbitrary-propagation --dynamic-assert-domain --runtime-assert-domain")
        ]
